                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="client-images">
                                    <img src="{{ asset('assets/template') }}/images/clients/amazon.svg" alt="client-img"
                            ...
                            <div class="swiper-slide">
                                <div class="client-images">
                                    <img src="{{ asset('assets/template') }}/images/clients/lenovo.svg" alt="client-img"
                                        class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="client-images">
                                    <img src="{{ asset('assets/template') }}/images/clients/paypal.svg" alt="client-img"
                                        class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                            <div class="swiper-slide">
